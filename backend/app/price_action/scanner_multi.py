...
class PriceActionScanner:
    ...
    MARKET_CLOSE = (15, 40)
    PATTERN_NAMES = (
        "5M RANGE BREAKOUT", "5M RANGE BREAKDOWN", "HEAD & SHOULDERS",
        "INVERSE HEAD & SHOULDERS", "TRIANGLE BREAKOUT", "TRIANGLE BREAKDOWN",
        "RISING WEDGE BREAKOUT", "RISING WEDGE BREAKDOWN",
        "FALLING WEDGE BREAKOUT", "FALLING WEDGE BREAKDOWN",
