...
const sortLabels={score:'Score',time:'Time',underlying:'Underlying',signal:'Signal',status:'Status',pattern:'Pattern',trigger_level:'Trigger',close_15min:'15M Price',vol_ratio_15m:'15M Volume',ema20:'EMA20',ema50:'EMA50'};
