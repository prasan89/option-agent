...
<div class="top"><div><div class="title">SLO Price Action</div><div class="sub">Historical 5-minute pattern detection • candle-close confirmation • research only</div><div class="nav"><a href="/dashboard">Flow Dashboard</a><a href="/strategy">SLO Options</a><a href="/dashboard/history">SLO History</a><a href="/price-action" class="active">Price Action</a><a href="/price-action/history">Price Action History</a><a href="/price-action/paper-pnl">Candlestick P&L</a></div></div><div id="status" class="status">Connecting…</div></div>
