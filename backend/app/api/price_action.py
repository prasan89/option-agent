...
def price_action_status() -> dict[str, Any]:
    ...
    return {
        ...
        "count": len(results),
        "scanner": stats,
        "method": "HISTORICAL_5MIN_MULTI_PATTERN",
        "research_only": True,
        "trading": "DISABLED",
        "note": "Historical 5-minute candles are scanned for range breakouts/breakdowns, H&S, triangles, wedges, flags and rounding structures. A close plus trend/volume confirmation is required before a signal is emitted.",
    }
...
<div class="panel"><div class="head"><strong>Triggered Historical Price Action Signals</strong><span id="updated" class="small">—</span></div><div class="table"><table><thead><tr><th>#</th><th>Time</th><th>Symbol</th><th>Signal</th><th>Pattern</th><th>Score</th><th>Trigger</th><th>5M Price</th><th>5M Vol</th><th>EMA20</th><th>EMA50</th><th>VWAP</th><th>Reason</th></tr></thead><tbody id="rows"><tr><td colspan="13" class="empty">No confirmed price-action signal yet.</td></tr></tbody></table></div></div>
